...
def main():
    ...
    if not baseline_exists or not scaler_exists:
        print(
            "      Note: Run 'python scripts/train_sweet_baseline_selection1.py' to create"
        )
    ...
    if all_checks_passed:
        ...
        if not baseline_exists:
            print(
                "  1. Train baseline model: python scripts/train_sweet_baseline_selection1.py"
            )
            print(
                "  2. Run transfer learning: python scripts/run_sweet_transfer_learning.py"
            )
        else:
            print(
                "  1. Run transfer learning: python scripts/run_sweet_transfer_learning.py"
            )
    else:
